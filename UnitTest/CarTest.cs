...
namespace UnitTest
{
	...
	class CarTest
	{
		...
		/// </summary>
		[Test]
		[TestCase(40,TestName = "Тест: Присваивание в Fuel положительного числа")]
		...
		[TestCase(41, ExpectedException = typeof(InvalidValueException), TestName = "Тест: Присваивание в Fuel числа, выходящего за интервал - 41 ")]
		...
		[TestCase(5, TestName = "Тест: Достаточное количество топлива граничное - 1")]
		...
		[TestCase(0, 40, TestName = "Тест заправка на 24 единицы")]
		[TestCase(35, 12.5,ExpectedException = typeof(InvalidValueException), TestName = "Тест на переполнение бака")]
